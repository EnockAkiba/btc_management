...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <!-- Main content -->
            <div class=" box-menu" style="min-height: auto; max-height:92vh; overflow:hidden;">

                <section class="content">
                    <div class="row">
                        <div class="col-md-1 d-none d-lg-block d-md-block mt-0 pb-2" style="height:92vh; overflow:auto">
                            <div class=" px-3 py-2">
