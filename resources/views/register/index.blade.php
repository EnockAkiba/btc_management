    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 col-md-3 ml-auto">
                <form action="" method="post" class="mt-0 pt-0 flex items-center bg-gray-100 border rounded-xl">
                    <input type="search" name="" class=" border-none outline-none p-2 bg-transparent w-full" placeholder="Recherche un apprenant">
                ...
                <div class=" overflow-auto mt-1 py-0">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <th>6h-8h</th>
                            <th>
                                <a class="bg-red-200 text-black p-2 ml-auto text-sm" data-toggle="modal" data-target="#addNew" href="#" role="button">Inscrire
                                </a>
                            </th>
                        </tbody>
                    </table>
