            ...
            <div class="card col-md-12 p-0">
                <div class="p-0">
                    <div class=" flex items-center justify-between">
                        ...
                        <a class="bg-blue text-white p-1 ml-auto" data-toggle="modal" data-target="#addNew" href="#" role="button">Add Devoir
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th>
                                    @if($quizze->content)
                                    {{($quizze->content)? substr($quizze->content,0,30).'...':'Null'}}
                                    @else
                                    Null
                                    @endif
                                </th>
                                <th>
                                    @if($quizze->file)
                                    <a href="{{asset('/'.$quizze->file)}}" target="_blank" class="bg-success p-1 text-sm"> Ouvrir</a>
                                    @else
                                ...
                                <th>
                                    <a href="{{route('quiz.show', $quizze)}}" class="text-success mx-2"><i class="fa fa-eye"></i> </a>
