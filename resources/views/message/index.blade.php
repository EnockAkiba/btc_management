...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item title d-none" id="userTitle"><a href="{{ route('message') }}">Njumbi</a>
                        </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                ...
                <div class="col-md-8" id="messages">
                    ...
                    <div class="card  direct-chat" style="height:80vh;  overflow-auto">
                        ...
                        <div class="card-body p-3 " style="height:80vh;  overflow-auto" id="messagesContent">
                            ...
                            <div class="direct-chat-messages" style="overflow: visible">
                                @for ($i = 1; $i < 20; $i++)
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formSend').addClass('d-none');
        });

        function ShowMessageindex() {
            $('#messages').removeClass('d-none');
            $('#messagesContent').removeClass('d-none');
            $('#formSend').removeClass('d-none');
            $("#welcome").addClass('d-none');
            $('#userTitle').removeClass('d-none')
            $("#row").addClass('flex-col-reverse');
        }
